...
export const SKILL_UNLOCKS: Partial<Record<keyof PlayerStats, SkillUnlock[]>> = {
    ...
    cooking: [
        { level: 1, description: 'Shrimps', category: 'Other' },
        { level: 15, description: 'Trout', category: 'Other' },
        { level: 25, description: 'Salmon', category: 'Other' },
        { level: 30, description: 'Tuna', category: 'Other' },
        { level: 40, description: 'Lobster', category: 'Other' },
        { level: 50, description: 'Swordfish', category: 'Other' },
        { level: 62, description: 'Monkfish', category: 'Other' },
        { level: 76, description: 'Sharks', category: 'Other' },
        { level: 80, description: 'Sea Turtle', category: 'Other' },
        { level: 84, description: 'Anglerfish', category: 'Other' },
        { level: 90, description: 'Dark Crabs', category: 'Other' }
    ],
    woodcutting: [
    ...
    fishing: [
        { level: 1, description: 'Shrimps', category: 'Other' },
        { level: 20, description: 'Trout', category: 'Other' },
        { level: 30, description: 'Salmon', category: 'Other' },
        { level: 35, description: 'Tuna', category: 'Other' },
        { level: 40, description: 'Lobster', category: 'Other' },
        { level: 50, description: 'Swordfish', category: 'Other' },
        { level: 62, description: 'Monkfish', category: 'Other' },
        { level: 76, description: 'Sharks', category: 'Other' },
        { level: 82, description: 'Anglerfish', category: 'Other' },
        { level: 85, description: 'Dark Crabs', category: 'Other' }
    ],
    mining: [
        { level: 1, description: 'Iron Pickaxe', category: 'Item' },
        { level: 6, description: 'Steel Pickaxe', category: 'Item' },
        { level: 15, description: 'Iron Ore', category: 'Other' },
        { level: 21, description: 'Mithril Pickaxe', category: 'Item' },
        { level: 30, description: 'Coal', category: 'Other' },
        { level: 31, description: 'Adamant Pickaxe', category: 'Item' },
        { level: 40, description: 'Gold Ore', category: 'Other' },
        { level: 41, description: 'Rune Pickaxe', category: 'Item' },
        { level: 55, description: 'Mithril Ore', category: 'Other' },
        { level: 61, description: 'Dragon Pickaxe', category: 'Item' },
        { level: 70, description: 'Adamantite Ore', category: 'Other' },
        { level: 85, description: 'Runite Ore', category: 'Other' },
        { level: 92, description: 'Amethyst', category: 'Other' }
    ],
    herblore: [
        { level: 3, description: 'Attack Potion', category: 'Other' },
        { level: 26, description: 'Energy Potion', category: 'Other' },
        { level: 38, description: 'Prayer Potion', category: 'Other' },
        { level: 45, description: 'Super Attack', category: 'Other' },
        { level: 55, description: 'Super Strength', category: 'Other' },
        { level: 63, description: 'Super Restore', category: 'Other' },
        { level: 66, description: 'Super Defence', category: 'Other' },
        { level: 72, description: 'Ranging Potion', category: 'Other' },
        { level: 81, description: 'Sara Brew', category: 'Other' },
        { level: 90, description: 'Super Combat', category: 'Other' }
    ],
    agility: [
    ...
    runecraft: [
        { level: 1, description: 'Air Runes', category: 'Other' },
        { level: 5, description: 'Water Runes', category: 'Other' },
        { level: 9, description: 'Earth Runes', category: 'Other' },
        { level: 14, description: 'Fire Runes', category: 'Other' },
        { level: 27, description: 'Cosmic Runes', category: 'Other' },
        { level: 44, description: 'Nature Runes', category: 'Other' },
        { level: 54, description: 'Law Runes', category: 'Other' },
        { level: 65, description: 'Death Runes', category: 'Other' },
        { level: 77, description: 'Blood Runes', category: 'Other' },
        { level: 90, description: 'Soul Runes', category: 'Other' },
        { level: 95, description: 'Wrath Runes', category: 'Other' }
    ],
    hunter: [
